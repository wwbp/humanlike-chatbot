    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                logger.log(
                    level,
                    f"Exiting {func.__name__} successfully in {execution_time:.3f}s",
                )
                return result
            except Exception as e:
                execution_time = time.time() - start_time
                logger.error(
                    f"Exiting {func.__name__} with exception after {execution_time:.3f}s: {e}",
                )
                raise
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs):
            ...
            try:
                ...
                logger.log(
                    level,
                    f"Exiting async {func.__name__} successfully in {execution_time:.3f}s",
                )
                return result
            except Exception as e:
                execution_time = time.time() - start_time
                logger.error(
                    f"Exiting async {func.__name__} with exception after {execution_time:.3f}s: {e}",
                )
                raise
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs):
            ...
            try:
                ...
                execution_time = time.time() - start_time
                logger.info(
                    f"Completed {request_type} request: {request_info} in {execution_time:.3f}s",
                )
                return result
            except Exception as e:
                execution_time = time.time() - start_time
                logger.error(
                    f"Failed {request_type} request: {request_info} after {execution_time:.3f}s: {e}",
                )
                raise
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs):
            ...
            try:
                ...
                execution_time = time.time() - start_time
                logger.debug(
                    f"Completed database operation: {operation} in {execution_time:.3f}s",
                )
                return result
            except Exception as e:
                execution_time = time.time() - start_time
                logger.error(
                    f"Failed database operation: {operation} after {execution_time:.3f}s: {e}",
                )
                raise
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs):
            ...
            try:
                ...
                execution_time = time.time() - start_time
                logger.debug(
                    f"External service call successful: {service_name} in {execution_time:.3f}s",
                )
                return result
            except Exception as e:
                execution_time = time.time() - start_time
                logger.error(
                    f"External service call failed: {service_name} after {execution_time:.3f}s: {e}",
                )
                raise
