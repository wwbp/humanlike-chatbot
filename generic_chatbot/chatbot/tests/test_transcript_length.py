...
from chatbot.models import Bot, Conversation, Utterance, Model, Persona
...
class TestTranscriptLength:
    ...
    @patch('chatbot.services.runchat.moderate_message')
    @patch('chatbot.services.runchat.save_chat_to_db')
    async def test_transcript_limit_5_messages(self, mock_save, mock_moderate, mock_get_engine):
    ...
    @patch('chatbot.services.runchat.moderate_message')
    @patch('chatbot.services.runchat.save_chat_to_db')
    async def test_transcript_limit_less_than_existing(self, mock_save, mock_moderate, mock_get_engine):
    ...
    @patch('chatbot.services.runchat.moderate_message')
    @patch('chatbot.services.runchat.save_chat_to_db')
    async def test_transcript_limit_exactly_matching(self, mock_save, mock_moderate, mock_get_engine):
    ...
    @patch('chatbot.services.runchat.moderate_message')
    @patch('chatbot.services.runchat.save_chat_to_db')
    async def test_empty_conversation_with_limit(self, mock_save, mock_moderate, mock_get_engine):
    ...
    @patch('chatbot.services.runchat.moderate_message')
    @patch('chatbot.services.runchat.save_chat_to_db')
    async def test_transcript_limit_with_persona(self, mock_save, mock_moderate, mock_get_engine):
    ...
    @patch('chatbot.services.runchat.save_chat_to_db')
    async def test_followup_with_transcript_limit(self, mock_save, mock_moderate, mock_get_engine):
